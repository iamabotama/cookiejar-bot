...
async def _build_help_text(is_admin: bool) -> str:
    ...
    if mode == "listener":
        public = (
            ...
            "`/updates`\nLatest updates from the last 2 weeks\n\n"
            "`/cj status`\nShow mode and entry counts\n\n"
            "`/cj announce`\nPost a public intro message\n\n"
            "`/help`\nThis message\n"
        )
        admin = (
            "\n\u2015\u2015\u2015\u2015\u2015\u2015\u2015\u2015\u2015\u2015\u2015\u2015\n"
            "`/cj` _(reply to a message)_\nSave it to the knowledge jar 🍪\n\n"
            "`/cj ingest <text or url>`\nSave text or scrape a URL\n\n"
            "`/cj crawl <url>`\nCrawl entire site and ingest all pages\n\n"
            "`/cj note <text>`\nSave an admin note\n\n"
            "`/cj pin <text or reply>`\nSave as high-priority\n\n"
            "`/cj stale <id>`\nMark an entry as stale\n\n"
            "`/cj deletelast`\nDelete the last entry (within 5 min)\n\n"
            "`/listentries`\nList active knowledge entries\n\n"
            "`/liststale`\nList stale entries\n\n"
            "`/syncnow`\nForce GitHub sync\n\n"
            "`/chatid`\nGet this channel's Telegram ID\n\n"
            "`/setmode answer`\nSwitch to answer mode\n"
        )
    else:
        public = (
            "🍪 *CookieJar — Answer Mode*\n\n"
            "`/ask <question>`\nAsk me about $COOK or Cookie Chain\n\n"
            "`/stats`\nSee how many cookies are in the jar\n\n"
            "`/updates`\nLatest updates from the last 2 weeks\n\n"
            "`/cj status`\nShow mode and entry counts\n\n"
            "`/cj announce`\nPost a public intro message\n\n"
            "`/start`\nWelcome message\n\n"
